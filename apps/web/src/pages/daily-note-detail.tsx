      ...
      <CardContent>
        {isEditing ? (
          ...
          <div className="flex flex-col gap-2">
            <Link to={`/papers/${note.moduleId}`} className="block rounded-md border border-border p-4 transition-colors hover:border-primary/40 hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
